                ...
                <div class="col-lg-12">
                    ...
                    <form role="form">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-4 col-lg-offset-4">
                                <button type="submit" id="login" class="btn btn-default"><span class="glyphicon glyphicon-log-in"></span>&nbsp; Login</button>
                            </div>
                        </div>
                    </form>
					
					<div class="form-group col-lg-6 col-lg-offset-4">
						<a href="register.php"><button type="submit" class="btn btn-default"> <span class="glyphicon glyphicon-user"></span>&nbsp; Not a Member? &nbsp; Register here</button></a>
					</div>
