    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
				...
				<h2 class="text-center">Welcome <?php echo $fname; echo " "; echo $lname; ?> - <a href="logout.php" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-log-out"></span> Logout</a></h2>
	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
            ...
            This article tells you whether you should drink coffee with coconut oil.</p>
		  </div>
